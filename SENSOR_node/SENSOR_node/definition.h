...
#define ADC_pin1()	{ADMUX |=0<<MUX4|0<<MUX3|0<<MUX2|0<<MUX1|0<<MUX0;
				bit_clear{PortE,BIT(2);}	
	// 0<<MUX3, MUX2, MUX0 and MUX1 = ADC0 (Pin setup, Page 232)}
	
	// PORTE setup for ADC0 input 
	
#define ADC_pin2()	{ADMUX |= 0<<MUX4|0<<MUX3|0<<MUX2|0<<MUX1|1<<MUX0;
	bit_clear{PortD,BIT(4);}
	// 0<<MUX3, MUX2 and MUX1 and 1<<MUX0 = ADC1 (Pin setup, Page 232)}
	
	// PORTD4 setup for ADC1 input	
	
#define ADC_pin2()	{ADMUX |= 0<<MUX4|0<<MUX3|0<<MUX2|1<<MUX1|0<<MUX0;
