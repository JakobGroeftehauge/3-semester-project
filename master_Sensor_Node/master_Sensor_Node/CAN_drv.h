...
#define Can_bit_timing(mode)  (can_fixed_baudrate())
...
//#define Can_set_ext_msk(mask)       { CANIDM1   = CAN_SET_EXT_ID_28_21(mask); \
    ...
    // ----------
				...
				//!< My own definitions
#define Can_enable_chosen_ints()		(CANGIE = ( 1 << ENIT ) | ( 1 << ENRX )) 


#define Set_can_ID(id)     {  CANIDT1 = id/8; CANIDT2 = (id & 0x07) << 5; CANIDT3 = 0x00; CANIDT4 = 0x00;	}
...
//!
extern uint8_t can_fixed_baudrate();



extern void setup_receive_mob(st_cmd_t* MObStruct);
