...
//------------------------------------------------------------------------------
#define ADC_setup() (ADCSRA= 1<<ADEN | 1<< ADSC |0<<ADATE| 0<<ADIF|0<< ADIE | 1<< ADPS2| 0<< ADPS1  |0<<ADPS0)
//1<< ADEN = Enable ADC
//1<< ADSC = Start ADC
...
#define ADC_input1() (ADMUX = 0<<REFS1 | 1<<REFS0 | 0<<ADLAR | 0<<MUX4|0<<MUX3|0<<MUX2|1<<MUX1|0<<MUX0)
...
#define ADC_input2() (ADMUX = 0<<REFS1 | 1<<REFS0 | 0<<ADLAR | 0<<MUX4 | 0<<MUX3 | 1<<MUX2 | 1<<MUX1 | 1<<MUX0)
//0<< REFS1 and 1<<REFS0 = External Vref and AVcc with external capacitor connected on the AREF pin.
//0<< ADLAR =  NOT Left adjusted ADC result
...
#define ADC_input3() (ADMUX = 0<<REFS1 | 1<<REFS0 | 0<<ADLAR| 0<<MUX4 | 1<<MUX3 | 0<<MUX2 | 0<<MUX1 | 0<<MUX0)
//0<< REFS1 and 1<<REFS0 = External Vref and AVcc with external capacitor connected on the AREF pin.
//0<< ADLAR = NOT Left adjusted ADC result
...
#define ADC_input4() (ADMUX = 0<<REFS1 | 1<<REFS0 | 0<<ADLAR | 0<<MUX4 | 0<<MUX3 | 0<<MUX2 | 1<<MUX1 | 1<<MUX0)
//0<< REFS1 and 1<<REFS0 = External Vref and AVcc with external capacitor connected on the AREF pin.
//0<< ADLAR = NOT Left adjusted ADC result
